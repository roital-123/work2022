...
7、memset()	/* include<string> */
   ...
   */
   ...
   int num[10] = { 0 };
   memset(num, 1, sizeof(num));	//num[i] = 16843009 （i=0，1，2，3）
   /*原因是：memset赋值是按照字节赋值的，int类型占四个字节，num一共40个字节，所以num[0]的每个字节赋值01，最后转换成十进制为16843009
   0000 0001 /0000 0001 /0000 0001 /0000 0001 num[i]的二进制形式，对应的十进制为16843009
   */
```
